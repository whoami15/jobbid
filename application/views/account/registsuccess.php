	...
	<table width="99%" style="padding-top:10px;padding-bottom:10px">
		<tbody>
			<tr>
				...
				Chúng tôi vừa gửi cho bạn 1 email xác nhận, vui lòng kiểm tra email <b><?php echo $_GET["username"] ?></b> (có thể nằm trong spam) để xác nhận việc đăng ký của bạn.<br/>
