	...
	<table width="99%" style="padding-top:10px;padding-bottom:10px">
		<tbody>
			<tr>
				...
				<div class='positive' style='margin-top:5px'><span class='bodytext' style='padding-left:30px;'>Bạn đã đăng dự án thành công!</span></div><br/>
				...
				<font color="red">Lưu ý : Dự án chỉ được đăng lên khi bạn đã xác nhận tài khoản.</font>
				</fieldset>
				</td>
			</tr>
		</tbody>
