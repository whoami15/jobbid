	...
	function constructor(caller, options) {
		...
		function initialize(instance) {
			...
			if( options.url != null && $.trim(options.url) != "" ) {
				...
				container.append("<iframe id='zendcms_iframe' style='display:none;' class='window_frame ui-widget-content no-draggable no-resizable "+options.frameClass+"' scrolling='"+scrollingHtml+"' src='"+options.url+"' width='100%' height='"+frameHeight+"px' frameborder='0'></iframe>");
