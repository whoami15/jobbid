...
<div class="editcell">
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th><?php echo JText::_('Tên loại tour'); ?></th>
			</tr>
		</thead>
	<?php
	$k = 0;
	for($i=0, $n=count($this->items); $i<$n ; $i++)
	{
		...
		$link             =     JRoute::_( 'index.php?option=com_tourdulich&controller=loaitour&action=loaitour&task=edit&cid[]='. $row->id );
		?>
		<tr class="<?php echo "row$k" ?>">
		<td>
		<?php echo $checked; ?>
		</td>
		<td><a href="<?php echo $link; ?>"><?php echo $row->tenloaitour; ?></a></td>
		</tr>
		<?php
		$k = 1 - $k;
	}
