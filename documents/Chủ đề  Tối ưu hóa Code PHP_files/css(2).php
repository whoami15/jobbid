...
#threaded_view h4 {
	background: #179c0b url(images/buttons/newbtn_middle.png) repeat-x  ;
...
.postbit .posthead .postdate.old, .postbitlegacy .posthead .postdate.old {
            background:transparent url(styles/xmas/statusicon/post_old.png) no-repeat center left;
}

.postbit .posthead .postdate.new, .postbitlegacy .posthead .postdate.new {
            background:transparent url(styles/xmas/statusicon/post_new.png) no-repeat center left;
}
