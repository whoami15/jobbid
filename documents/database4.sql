...
insert  into `linhvucs`(`id`,`tenlinhvuc`,`soduan`) values ('cntt','Công nghệ thông tin',3),('co_khi','Cơ khí',2),('design','Thiết kế',3),('dien_tu','Điện tử 1',2),('khac','Khác',1),('kien_truc','Kiến trúc',5),('seo','SEO',NULL);
...
insert  into `ppl_onlines`(`id`,`activity`,`access_time`,`account_id`,`ip_address`,`refurl`,`user_agent`) values (1,'2010-12-28 15:18:55','2010-12-28 15:18:09',NULL,'127.0.0.1',NULL,'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0)'),(2,'2010-12-28 16:43:36','2010-12-28 15:19:37',NULL,'127.0.0.1',NULL,'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0)'),(3,'2010-12-28 16:43:48','2010-12-28 16:18:19',1,'127.0.0.1',NULL,'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.2.13) Gecko/20101203 Firefox/3.6.13');
