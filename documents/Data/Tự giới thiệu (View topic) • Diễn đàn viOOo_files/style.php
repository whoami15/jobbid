...
dl.codebox, dl.codeboxexp {
	background-color: #FFFFFF;
	border: 1px solid #d8d8d8;
	font-size: 1em;
}

dl.codebox dt, dl.codeboxexp dt {
	text-transform: uppercase;
	border-bottom: 1px solid #CCCCCC;
	margin-bottom: 3px;
	font-size: 0.8em;
...
blockquote dl.codebox, blockquote dl.codeboxexp {
	margin-left: 0;
}
...
dl.codebox    dt a.codebox    { display: inline }
dl.codebox    dt a.codeboxexp { display: none }
dl.codeboxexp dt a.codebox    { display: none }
dl.codeboxexp dt a.codeboxexp { display: inline }
...
.forumbg {
	...
	background-image: url("./styles/prosilver/theme/images/bg_forum.gif");
}
